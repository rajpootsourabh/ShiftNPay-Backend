...
const clientSchema = new mongoose.Schema({
  ...
  erVisitPrior: Date,
  caseManager:  { type: mongoose.Schema.Types.ObjectId, ref: 'CaseManager' },
  caseManager2:  { type: mongoose.Schema.Types.ObjectId, ref: 'CaseManager' },
  caseManager3:  { type: mongoose.Schema.Types.ObjectId, ref: 'CaseManager' },
  ambulatory: String,
  ...
  clientType: { type: mongoose.Schema.Types.ObjectId, ref: 'ClientTypes' },
